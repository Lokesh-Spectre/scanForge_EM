...
void gatts_service_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    switch (event) {
        ...
        case ESP_GATTS_CREATE_EVT:
            ...
            gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_COMMAND_CONTROL;
            
            gl_profile_tab[PROFILE_A_APP_ID].char_uuid_2.len = ESP_UUID_LEN_16;
            gl_profile_tab[PROFILE_A_APP_ID].char_uuid_2.uuid.uuid16 = GATTS_CHAR_UUID_SCANNING_STATUS;
            ...
            add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle, &gl_profile_tab[PROFILE_A_APP_ID].char_uuid_2,
                                                            ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
                                                            a_property,
                                                            &gatts_demo_char1_val, NULL);
            if (add_char_ret){
        ...
        case ESP_GATTS_ADD_CHAR_EVT:
            ...
            if (param->add_char.char_uuid.uuid.uuid16 == GATTS_CHAR_UUID_COMMAND_CONTROL){
                ...
                gl_profile_tab[PROFILE_A_APP_ID].descr_uuid_2.len = ESP_UUID_LEN_16;
                gl_profile_tab[PROFILE_A_APP_ID].descr_uuid_2.uuid.uuid16 = 0xFACE;
                esp_err_t get_attr_ret = esp_ble_gatts_get_attr_value(param->add_char.attr_handle,  &length, &prf_char);
            }
